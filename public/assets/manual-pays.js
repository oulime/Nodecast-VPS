(() => {
  ...
  const st={sources:[],source:null,kind:"live",packages:[],loadedKinds:new Set(),loadingKinds:new Map(),allPackages:{live:[],vod:[],series:[]},countries:[],assigned:new Map(),packageStreams:new Map(),packageOrders:new Map(),packageKinds:new Map(),visibleCountries:new Set(),activeCountry:null,pendingDeleteCountry:null,loaded:false,loadingCount:0}, $=id=>document.getElementById(id);
