...
async function countEntries(url) {
    ...
    // Some IPTV providers return non-standard statuses while still sending valid M3U content.
    // Keep strict failure for empty/invalid responses, but accept parsed content when present.
