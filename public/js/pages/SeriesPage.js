...
class SeriesPage {
    ...
    renderPackageHub() {
        let hubContainer = document.getElementById('series-pkg-hub');
        if (!hubContainer) {
            if (this.categorySelect) {
                hubContainer = document.createElement('div');
                hubContainer.id = 'series-pkg-hub';
                ...
                hubContainer = document.createElement('div');
                hubContainer.id = 'series-pkg-hub';
                const filterBar = document.querySelector('#page-series .filters-bar, #page-series .page-header, .series-header') || this.container?.parentNode;
        ...
        const items = this.categories.length > 0
            ? [
                { value: '', name: 'TOUTES LES SÉRIES', color: 'bg-blue' },
        ...
        hubContainer.innerHTML = `
            <div class="pkg-hub-wrapper" id="series-hub-wrapper">
                <div class="pkg-hub-trigger" id="series-hub-btn" role="button" aria-expanded="false" aria-haspopup="listbox" tabindex="0">
                    <div class="pkg-hub-subtitle">FORFAIT ACTUEL</div>
                    <div class="pkg-hub-title" id="series-hub-title">${this.selectedPkg.name}</div>
                </div>

                <div class="pkg-hub-dropdown" id="series-hub-dropdown" role="listbox" aria-label="Sélecteur de forfaits">
                    <button type="button" class="pkg-hub-arrow left-arrow" id="series-hub-arrow-left" aria-label="Forfait précédent">&lt;</button>
                    <div class="pkg-hub-fan-container" id="series-hub-fan-container"></div>
                    <button type="button" class="pkg-hub-arrow right-arrow" id="series-hub-arrow-right" aria-label="Forfait suivant">&gt;</button>
                </div>
            </div>
        `;

        this.hubBtn = hubContainer.querySelector('#series-hub-btn');
        this.hubTitle = hubContainer.querySelector('#series-hub-title');
        this.hubDropdown = hubContainer.querySelector('#series-hub-dropdown');
        this.hubFanContainer = hubContainer.querySelector('#series-hub-fan-container');
        this.hubArrowLeft = hubContainer.querySelector('#series-hub-arrow-left');
        this.hubArrowRight = hubContainer.querySelector('#series-hub-arrow-right');
