...
class SettingsPage {
    ...
    async initTranscodingSettings() {
        ...
        const hardwareModeSelect = document.getElementById('setting-hardware-mode');
        ...
        if (hardwareModeSelect) hardwareModeSelect.value = s.transcodeHardwareMode || 'auto';
        ...
        hardwareModeSelect?.addEventListener('change', () => {
            this.app.player.settings.transcodeHardwareMode = hardwareModeSelect.value;
            this.app.player.saveSettings();
        });
