...
(function () {
      ...
      if (isLive) {
        ...
        centerStatusHtml =
          '<div class="vel-football-modal-status-badge is-upcoming ' + (isStartingSoon ? 'is-starting-soon' : '') + '">' +
            '<div class="vel-football-modal-time-circle">' +
              '<svg class="vel-time-ring-svg" viewBox="0 0 100 100" aria-hidden="true">' +
                '<circle class="vel-time-ring-track" cx="50" cy="50" r="44"></circle>' +
                '<circle class="vel-time-ring-runner" cx="50" cy="50" r="44"></circle>' +
              '</svg>' +
              '<span class="vel-football-modal-kickoff-time">' + kickoffTime + '</span>' +
            '</div>' +
  ...
  function injectFootballToastStyles() {
    ...
    st.textContent = [
      ...
      '  gap: 0.45rem;',
      '}',
      '.vel-football-modal-time-circle {',
      '  position: relative;',
      '  width: 78px;',
      '  height: 78px;',
      '  display: flex;',
      ...
      '  stroke-width: 3;',
      '}',
      '.vel-time-ring-runner {',
      '  fill: none;',
      '  stroke: var(--comp-theme-color, #38bdf8);',
      '  stroke-width: 3.5;',
      '  stroke-linecap: round;',
      '  stroke-dasharray: 60 220;',
      '  transform-origin: 50px 50px;',
      '  animation: velTimeRingSpin 2.6s linear infinite;',
      '  filter: drop-shadow(0 0 6px var(--comp-theme-glow, rgba(56, 189, 248, 0.6)));',
      '}',
      '@keyframes velTimeRingSpin {',
