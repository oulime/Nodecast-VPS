(() => {
  ...
  const COMMON_BRAND_LOGOS = [
    ...
    { match: /paramount/i, logo: 'https://i.imgur.com/3nbub9F.png' },
    { match: /sky\s*sport|sky\s*cinema|sky\s*show/i, logo: 'https://i.imgur.com/VfYEc6f.png' },
    { match: /ligue\s*1|ligue1/i, logo: 'https://i.imgur.com/RxSgeix.png' },
    { match: /roland\s*garros/i, logo: 'https://i.imgur.com/8Qh1mR4.png' },
    { match: /l\'?equipe/i, logo: 'https://i.imgur.com/8Qh1mR4.png' },

    // Universal IPTV Categories & Thematics
    { match: /documentaire|documentaires|docu|discovery|science|nature|animaux|geographie|history|histoire|planete/i, logo: 'https://i.imgur.com/fNA00VF.png' },
    { match: /caribbean|caraibe|caraibes|antilles|tropical|dom\s*tom|guadeloupe|martinique|guyane|reunion|haiti/i, logo: 'https://i.imgur.com/ZHD7Vxy.png' },
    { match: /musique|music|hits|clips|radio|mtv|chanson/i, logo: 'https://i.imgur.com/GlfrYs7.png' },
    { match: /jeunesse|kids|enfant|enfants|cartoon|cartoons|animation|anime|manga|gulli|nickelodeon|junior|baby/i, logo: 'https://i.imgur.com/UxrAiAe.png' },
    { match: /cinema|cinemas|cine|film|films|movie|movies|action|box\s*office|blockbuster/i, logo: 'https://i.imgur.com/5HcyMnW.png' },
    { match: /information|infos|info|news|actualite|actualites|24\/7|bfm|cnews|lci/i, logo: 'https://i.imgur.com/Skf6vdi.png' },
    { match: /sport|sports|football|foot|soccer|champions|arena|combat|mma|ufc/i, logo: 'https://i.imgur.com/8Qh1mR4.png' },
    { match: /general|generaliste|generalistes|nationaux|tnt|direct|principales|national/i, logo: 'https://i.imgur.com/QxHt9NC.png' },
    { match: /divertissement|entertainment|spectacle|show|humour|comedy/i, logo: 'https://i.imgur.com/7GVp3fW.png' },
    { match: /serie|series|feuilleton|drama/i, logo: 'https://i.imgur.com/rG7bV4Z.png' },
    { match: /region|regionales|locales|terroir|france3|regions/i, logo: 'https://i.imgur.com/QxHt9NC.png' },
    { match: /afrique|africa|africaines|africain/i, logo: 'https://i.imgur.com/5HcyMnW.png' },
    { match: /arabe|arabic|maghreb|oriental|arab/i, logo: 'https://i.imgur.com/CiA3plN.png' }
  ];
